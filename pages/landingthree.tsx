...
const features = [
  {
    ...
    description:
      'We aim to bridge the gap between the efficiency of visual communication and the complexity of coding by translating your code into a compelling visual narrative, showcasing your hard work.',
    href: '#',
    icon: StarIcon,
  },
  {
    ...
    description:
      'Your GitConnect portfolio is yours to edit and share, connecting you with a community of peers for inspiration and collaboration.',
    href: '#',
    icon: UserGroupIcon,
  },
  {
    ...
    description:
      'Our mission at GitConnect is to foster innovation by providing a platform for all developers, from beginners to experts, to share and bring their projects to life.',
    href: '#',
    icon: SparklesIcon,
  },
];
...
const tiers = [
  ...
  },
  {
    ...
    href: '#',
    priceMonthly: '$15 AUD',
    description: 'Build the ultimate portfolio - heaps more coming soon.',
    features: [
      'Unlimited projects',
    ...
    <p className="mt-4 text-lg text-gray-700">Devs are capable of incredible things and we want to give you a place to share whatever your ‘incredible thing’ might be. Whether you are a budding developer looking to create a professional presence online or a seasoned software engineer wanting to showcase your magnum opus -GitConnect is for you.</p>
        ...
        <div className="relative isolate mt-32 bg-white px-6 sm:mt-56 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
            ...
            If you want to contribute to this vision, you can lock in a discount rate now
            with 40% off for limited time - use code EARLYBIRD.
          </p>
          ...
          <div className="sm:px-6 lg:px-60">
            <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32">
              ...
              <div className="mx-auto max-w-7xl">
                ...
                <p className="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">
                  We're in the early stages, but our future is ambitious. We're committed
