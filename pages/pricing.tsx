...
// // Define the structure of your tier object
// type Tier = {
//   id: string;
//   name: string;
//   price: Record<Frequency, string>;
//   discountedPrice?: Record<Frequency, string>; // Make it optional if not all tiers have discounted prices
//   // ... other properties
// };

// Your pricing object should match the Tier type
// const pricing = {
//   tiers: Array<Tier>, // Populate with your tiers data
//   // ... other properties
// };
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            ...
            <div className="flex flex-col border-t border-white/10 pt-10 sm:pt-16 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0 xl:pl-20">
              ...
              <figure className="mt-10 flex flex-auto flex-col justify-between">
                <blockquote className="text-lg leading-8 text-white">
                  <p>
                    “Excepteur veniam labore ullamco eiusmod. Pariatur consequat proident
                    duis dolore nulla veniam reprehenderit nisi officia voluptate
                    incididunt exercitation exercitation elit. Nostrud veniam sint dolor
                    nisi ullamco.”
                  </p>
                </blockquote>
                <figcaption className="mt-10 flex items-center gap-x-6">
