...
import { TextInput, Textarea, Group, Button, Container, Stack, Drawer } from '@mantine/core';
...
// Outcome:
  ...
  const form = useProjectForm({
    initialValues: {
      ...
      solutions: 'Github API to import public projects, lots of helper functions, project pages for each project, ai generation for project assistance',
      learnings: 'Heaps - how to start a company, how not to start a company, honestly how to code altogether',
