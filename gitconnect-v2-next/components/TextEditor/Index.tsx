...
export default function TextEditor() {
  ...
  const editor = useEditor({
    ...
    content:
      '<p>This starter Next.js project includes a minimal setup for server side rendering, if you want to learn more on Mantine + Next.js integration follow this guide. To get started edit index.tsx file.</p>',
    // editable: false,
  })
